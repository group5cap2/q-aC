...
import Q4plus2 from "../q4 plus2";
const Q4plus = ({ score, setScore, name }) => {
  //
    ...
    <div>
      {showQ2 ? (
        <div>
          ...
          <div className="qH2">
            <h2 className="Qu">افضل لعبة اونلاين بالنسبة لي ؟</h2>
          </div>
        ...
        <div>{<Q4plus2 setScore={setScore} score={score} name={name} />}</div>
