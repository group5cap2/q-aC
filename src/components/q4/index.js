...
import Q4plus from "../q4 plus";
const Q4 = ({ score, setScore, name }) => {
  //
    ...
    <div>
      {showQ2 ? (
        <div>
          ...
          <div className="qH2">
            <h2 className="Qu">افضل باند بالنسبة لي هي ؟</h2>
          </div>
        ...
        <div>{<Q4plus setScore={setScore} score={score} name={name} />}</div>
