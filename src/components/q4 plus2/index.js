...
import Q4plus3 from "../q4 plus3";
const Q4plus2 = ({ score, setScore, name }) => {
  //
    ...
    <div>
      {showQ2 ? (
        <div>
          ...
          <div className="qH2">
            <h2 className="Qu">اكثر لعبة العبها الفترة هذي ؟</h2>
          </div>
        ...
        <div>{<Q4plus3 setScore={setScore} score={score} name={name} />}</div>
